...
suite('client user', () => {
    let name = 'testing';
    let hashOfName = 'z4DNiu1ILV0VJ9fccvzv+E5jJlkoSER9LcCw6H38mpA=';
    let password = 'm0nk3y123';
    let keyFromNameAndPassword = 'U2E8RFhyMWpvho4pDlB3q-9smxdWU_WzVj_Tc1aDC7Y';
